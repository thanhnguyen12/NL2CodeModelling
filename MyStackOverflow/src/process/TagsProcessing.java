...
public class TagsProcessing {
	...
	public ThreadData processThread(long questionId){
	...
	public QuestionData getQuestionInfo(long questionId) {		
		...
		PosterData poster = new PosterData(question.getOwner().getUserId(), question.getOwner().getDisplayName(), question.getOwner().getReputation());
...
//		Logger.log("Questionid: " + questionId);
	...
	public ArrayList<AnswerData> getAnswerData(long questionId) {
		...
		for (Answer answer : answers) {
			...
			PosterData poster = new PosterData(answer.getOwner().getUserId(), answer.getOwner().getDisplayName(), answer.getOwner().getReputation());
